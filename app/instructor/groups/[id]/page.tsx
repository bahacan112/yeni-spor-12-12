...
export default function InstructorGroupDetailPage() {
  ...
  const [studentsRows, setStudentsRows] = useState<any[]>([]);
  ...
  const filteredStudents = (
    studentsRows.length ? studentsRows : students
  ).filter((student: any) =>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-slate-400">
            {(groupInfo?.sport_type || groupData.sportType) +
              " • " +
              (groupInfo?.schedule || groupData.schedule)}
          </p>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">
                  {groupInfo?.capacity || groupData.studentCount}
                </p>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1">
                      <span className="text-xs text-slate-400">
                        Katılım: %{student.attendance}
                      </span>
                      <span className="text-xs text-slate-400">
                        Performans: {student.performance}/10
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <TabsContent value="trainings" className="space-y-4">
          <Card className="bg-slate-900 border-slate-800">
            ...
            <CardContent className="space-y-3">
              {(recentRows.length ? recentRows : recentTrainings).map(
                (training: any) => (
                  <div
                    key={training.id}
