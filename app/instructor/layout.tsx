    ...
    <div className="flex min-h-screen bg-slate-950">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex h-14 items-center justify-between border-b border-slate-800 bg-slate-900 px-4 md:hidden">
        ...
        <Avatar className="h-8 w-8">
          ...
          <AvatarFallback className="bg-emerald-600 text-white text-xs">AK</AvatarFallback>
        </Avatar>
      </div>
          ...
          <div className={cn("flex items-center gap-3 rounded-lg px-3 py-2", sidebarCollapsed && "justify-center")}>
            ...
            {!sidebarCollapsed && (
              <div className="flex-1 overflow-hidden">
                <p className="truncate text-sm font-medium text-white">Ahmet Koç</p>
                <p className="truncate text-xs text-slate-400">Futbol Eğitmeni</p>
              </div>
            )}
          </div>
          <Link
