...
export async function getWebsiteData() {
  ...
  if (tenantError) throw new Error("Failed to fetch tenant");
  ...
  const homePage: WebsitePage | null = homePageData
    ? {
        id: homePageData.id,
  ...
  const aboutPage: WebsitePage | null = aboutPageData
    ? {
        id: aboutPageData.id,
  ...
  const contactPage: WebsitePage | null = contactPageData
    ? {
  ...
  const branchesPage: WebsitePage | null = branchesPageData
    ? {
